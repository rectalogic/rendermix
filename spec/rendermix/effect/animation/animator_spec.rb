          ...
          on_render_thread do
            ...
            expected = {
              0.0 => transform([19.921131, 17.970163, 1.2984331],
                               [0.16841672, 0.70654154, -0.6867049, 0.029517174]),
              0.2 => transform([19.477676, 18.432915, 2.8934274],
                               [0.16994369, 0.7501147, -0.63683355, 0.053759832]),
              0.4 => transform([18.601229, 19.34752, 6.0424194],
                               [0.16901927, 0.8436458, -0.4905827, 0.13792343]),
              0.5 => transform([18.35538, 19.604097, 6.9256077],
                               [0.16245441, 0.8772834, -0.40689248, 0.19601262]),
              0.8 => transform([19.988829, 17.228533, 3.8785667],
                               [0.07639749, 0.8759054, -0.11478704, 0.46236038]),
              1.0 => transform([21.369244, 15.234458, 1.2472537],
                               [-7.42584E-4, 0.82161534, 0.0026692138, 0.5700356]),
            }
